            ...
            <>
              ...
              <div className="form-row">
                ...
                <input
                  ...
                  required
                />
                {formErrors.fecha_nacimiento && <span className="error">{formErrors.fecha_nacimiento}</span>}
              </div>
              ...
              <div className="form-row">
                ...
                <input
                  ...
                  required
                />
                {formErrors.pais && <span className="error">{formErrors.pais}</span>}
              </div>
              ...
              <div className="form-row">
                ...
                {formErrors.genero && <span className="error">{formErrors.genero}</span>}
              </div>
